...
## Releasing
- [KubeFlux: an HPC Scheduler Plugin for Kubernetes]("src\KubeFlux_an_HPC_Scheduler_Plugin_for_Kubernetes.pdf")
- [Releasing Kubernetes Less Often and More Secure]("src\Releasing_Kubernetes_Less_Often_and_More_Secure.pdf")
...
- [OpenTelemetry:the Open Source Vision for Unified Observability]("src\Horovits_OpenTelemetry.pdf")
- [Intro to Kubernetes, GitOps, and Observability]("src\Intro_to_Kubernetes_GitOps_Observability_KubeCon_EU_2022.pdf")
- [Jaeger present and future]("src\Jaeger.pdf")
- [kubectl events]("src\kubectl_events.pdf")
- [Monitoring Prometheus Way]("src\Monitoring_the_Prometheus_Way_KubeCon_Valencia_May_2022.pdf")
- [Tail-Based Sampling in the OpenTelemetry Collector]("src\Why_How_to_and_Issues_Tail-Based_Sampling_in_the_OpenTelemetry_Collector.pdf")
- [Working your Cluster: Smarter Scheduling Decisions for Your Workloads]("src\working-your-cluster-smarter-scheduling-decisions-for-your-workloads.pdf")

## Serverless

- [Empower Autonomous Driving with cloud native Serverless technologies]("src\Empower_Autonomous_Driving_with_cloud_native_Serverless_technologies.pdf")
- [CNCF Serverless Workflow with Kogito and Knative]("src\Kogito_Serverless_Workflow")
- [Operating Prometheus in a Serverless World]("src\Operating_Prometheus_in_a_Serverless_World.pdf")

## Multicloud
- [Choosing cloud native technologies for the journey to multi-cloud]("src\ChoosingCloudNativeTechnologiesForMultiCloud.pdf")
- [Sailing Multi Cloud Traffic Management With Karmada]("src\Sailing_Multi_Cloud_Traffic_Management_With_Karmada_ZhonghuXu.pdf")
...
- [A Crash Course on the Intricacies of Managing CPUs in K8s]("src\crash_course_managing_CPUs_in_K8s_Kubecon_2022")

## DB's
- [Adapting TiKV for Cloud Storage]("src\CNCF_Adapting_TiKV_for_Cloud_Storage.pdf")
- [CockroachDB The Definitive Guide]("src\oreilly-cockroachdb-the-definitive-guide-1.pdf")
- [Scaling Databases with Vitess]("src\Scaling_Databases_with_Vitess.pdf")
...
- [Network aware scheduling]("src\KubeCon_EU_2022_JoseSantos_ChenWang_final.pdf")
- [It’s all for the users. More durable, secure and pluggable. KubeVirt v0.53]("src\KubeCon_EU_2022_KubeVirt_Maintainer_Track.pdf")
- [The Power of Cloud Native in Financial Institutions]("src\KubeCon_EU_2022_MPruchniak.pdf")
- [Operator Framework]("src\Kubecon_EU_2022_Operator_Framework.pdf")
- [Harbor: enterprise cloud native artifact registry]("src\KubeCon_EU_2022_Presentation_Harbor_v1.pptx")
...
## Batch Procesing
- [Intro & Deep dive Volcano: A Cloud Native Batch System]("src\KubeCon_EU_2022_Volcano_Intro-v2.0.pdf")
...
## Project Updates
- [Containerd]("src\2022-KubeconEU-containerd.pdf")
